 ...
 * Git Info SHA1: 6fdb90df179d84b71018f5b0840c098542f8b734 Date: Thu May 26 17:04:27 2011 -0700
...
e)};a[d]=a[d]||{};a[d][e]=function(a,e){arguments.length&&this._createWidget(a,e)};b=new b;b.options=a.extend(!0,{},b.options);a[d][e].prototype=a.extend(!0,b,{namespace:d,widgetName:e,widgetEventPrefix:a[d][e].prototype.widgetEventPrefix||e,widgetBaseClass:j},c);a.widget.bridge(e,a[d][e])};a.widget.bridge=function(e,b){a.fn[e]=function(d){var i=typeof d==="string",j=Array.prototype.slice.call(arguments,1),k=this,d=!i&&j.length?a.extend.apply(null,[!0,d].concat(j)):d;if(i&&d.charAt(0)==="_")return k;
i?this.each(function(){var b=a.data(this,e);if(!b)throw"cannot call methods on "+e+" prior to initialization; attempted to call method '"+d+"'";if(!a.isFunction(b[d]))throw"no such method '"+d+"' for "+e+" widget instance";var f=b[d].apply(b,j);if(f!==b&&f!==c)return k=f,!1}):this.each(function(){var c=a.data(this,e);c?c.option(d||{})._init():a.data(this,e,new b(d,this))});return k}};a.Widget=function(a,b){arguments.length&&this._createWidget(a,b)};a.Widget.prototype={widgetName:"widget",widgetEventPrefix:"",
...
d);return!(a.isFunction(i)&&i.call(this.element[0],c,d)===!1||c.isDefaultPrevented())}}})(jQuery);(function(a,c){a.widget("mobile.widget",{_getCreateOptions:function(){var d=this.element,b={};a.each(this.options,function(a){var f=d.jqmData(a.replace(/[A-Z]/g,function(a){return"-"+a.toLowerCase()}));f!==c&&(b[a]=f)});return b}})})(jQuery);
...
var h=a("<a href='testurl'></a>").prependTo(b)[0].href;d[0].href=f?f:location.pathname;e&&e.remove();return h.indexOf(c)===0}(),eventCapture:"addEventListener"in document});b.remove();a.support.boxShadow||a("html").addClass("ui-mobile-nosupport-boxshadow")})(jQuery);
(function(a,c,d,b){function e(a){for(;a&&typeof a.originalEvent!=="undefined";)a=a.originalEvent;return a}function f(b){for(var c={};b;){var d=a.data(b,u),e;for(e in d)if(d[e])c[e]=c.hasVirtualBinding=!0;b=b.parentNode}return c}function g(){s&&(clearTimeout(s),s=0);s=setTimeout(function(){z=s=0;B.length=0;E=!1;A=!0},a.vmouse.resetTimerDuration)}function i(c,d,f){var h=!1,p;if(!(p=f&&f[c])){if(f=!f)a:{for(f=d.target;f;){if((p=a.data(f,u))&&(!c||p[c]))break a;f=f.parentNode}f=null}p=f}if(p){h=d;f=h.type;
h=a.Event(h);h.type=c;var g=h.originalEvent,i=a.event.props;if(g)for(c=i.length;c;)p=i[--c],h[p]=g[p];if(f.search(/^touch/)!==-1&&(c=e(g),f=c.touches,c=c.changedTouches,f=f&&f.length?f[0]:c&&c.length?c[0]:b)){c=0;for(g=w.length;c<g;c++)p=w[c],h[p]=f[p]}a(d.target).trigger(h);h=h.isDefaultPrevented()}return h}function j(b){var c=a.data(b.target,v);!E&&(!z||z!==c)&&i("v"+b.type,b)}function k(b){var c=e(b).touches;if(c&&c.length===1){var d=b.target,c=f(d);if(c.hasVirtualBinding)z=t++,a.data(d,v,z),s&&
(clearTimeout(s),s=0),y=A=!1,d=e(b).touches[0],r=d.pageX,p=d.pageY,i("vmouseover",b,c),i("vmousedown",b,c)}}function m(a){A||(y||i("vmousecancel",a,f(a.target)),y=!0,g())}function l(b){if(!A){var c=e(b).touches[0],d=y,h=a.vmouse.moveDistanceThreshold;y=y||Math.abs(c.pageX-r)>h||Math.abs(c.pageY-p)>h;c=f(b.target);y&&!d&&i("vmousecancel",b,c);i("vmousemove",b,c);g()}}function h(a){if(!A){A=!0;var b=f(a.target);i("vmouseup",a,b);if(!y&&i("vclick",a,b)){var c=e(a).changedTouches[0];B.push({touchID:z,
x:c.clientX,y:c.clientY});E=!0}i("vmouseout",a,b);y=!1;g()}}function o(b){var b=a.data(b,u),c;if(b)for(c in b)if(b[c])return!0;return!1}function n(){}function q(b){var c=b.substr(1);return{setup:function(){o(this)||a.data(this,u,{});a.data(this,u)[b]=!0;x[b]=(x[b]||0)+1;x[b]===1&&C.bind(c,j);a(this).bind(c,n);if(F)x.touchstart=(x.touchstart||0)+1,x.touchstart===1&&C.bind("touchstart",k).bind("touchend",h).bind("touchmove",l).bind("scroll",m)},teardown:function(){--x[b];x[b]||C.unbind(c,j);F&&(--x.touchstart,
x.touchstart||C.unbind("touchstart",k).unbind("touchmove",l).unbind("touchend",h).unbind("scroll",m));var d=a(this),e=a.data(this,u);e&&(e[b]=!1);d.unbind(c,n);o(this)||d.removeData(u)}}}var u="virtualMouseBindings",v="virtualTouchID",c="vmouseover vmousedown vmousemove vmouseup vclick vmouseout vmousecancel".split(" "),w="clientX clientY pageX pageY screenX screenY".split(" "),x={},s=0,r=0,p=0,y=!1,B=[],E=!1,A=!1,F=a.support.eventCapture,C=a(d),t=1,z=0;a.vmouse={moveDistanceThreshold:10,clickDistanceThreshold:10,
resetTimerDuration:1500};for(var D=0;D<c.length;D++)a.event.special[c[D]]=q(c[D]);F&&d.addEventListener("click",function(b){var c=B.length,d=b.target;if(c)for(var e=b.clientX,f=b.clientY,h=a.vmouse.clickDistanceThreshold,p=d;p;){for(var g=0;g<c;g++){var i=B[g];if(p===d&&Math.abs(i.x-e)<h&&Math.abs(i.y-f)<h||a.data(p,v)===i.touchID){b.preventDefault();b.stopPropagation();return}}p=p.parentNode}},!0)})(jQuery,window,document);
...
"")+f;h=setTimeout(g,a.fn[e].delay)}var i={},h,j=b(),n=function(a){return a},q=n,u=n;i.start=function(){h||g()};i.stop=function(){h&&clearTimeout(h);h=d};a.browser.msie&&!k&&function(){var c,d;i.start=function(){if(!c)d=(d=a.fn[e].src)&&d+b(),c=a('<iframe tabindex="-1" title="empty"/>').hide().one("load",function(){d||q(b());g()}).attr("src",d||"javascript:0").insertAfter("body")[0].contentWindow,f.onpropertychange=function(){try{if(event.propertyName==="title")c.document.title=f.title}catch(a){}}};
i.stop=n;u=function(){return b(c.location.href)};q=function(b,d){var h=c.document,p=a.fn[e].domain;if(b!==d)h.title=f.title,h.open(),p&&h.write('<script>document.domain="'+p+'"<\/script>'),h.close(),c.location.hash=b}}();return i}()})(jQuery,this);
...
(function(a,c){function d(b){l&&(!l.closest(".ui-page-active").length||b)&&l.removeClass(a.mobile.activeBtnClass);l=null}function b(){q=!1;n.length>0&&a.mobile.changePage.apply(null,n.pop())}function e(b,c,d,e){a.mobile.silentScroll();var f=i.scrollTop();c&&(c.jqmData("lastScroll",f).jqmData("lastClicked",l),c.data("page")._trigger("beforehide",null,{nextPage:b}));b.data("page")._trigger("beforeshow",null,{prevPage:c||a("")});a.mobile.hidePageLoadingMsg();d=(a.mobile.transitionHandlers[d||"none"]||
...
"a")break;a=a.parentNode}return a}var i=a(window),j=a("html"),k=a("head"),m={get:function(a){if(a===c)a=location.hash;return m.stripHash(a).replace(/[^\/]*\.[^\/*]+$/,"")},getFilePath:function(b){var c="&"+a.mobile.subPageUrlKey;return b&&b.split(c)[0].split(u)[0]},set:function(a){location.hash=a},origin:"",setOrigin:function(){m.origin=m.get(location.protocol+"//"+location.host+location.pathname)},makeAbsolute:function(a){var b=m.isPath(location.hash);if(m.isQuery(a))return(b?m.cleanHash(location.hash):
location.pathname)+a;return(b?m.get():m.get(location.pathname))+a},isPath:function(a){return/\//.test(a)},isQuery:function(a){return/^\?/.test(a)},clean:function(a){return a.replace(RegExp("^"+location.protocol+"//"+location.host),"")},stripHash:function(a){return a.replace(/^#/,"")},cleanHash:function(a){return m.stripHash(a.replace(/\?.*$/,"").replace(u,""))},isExternal:function(a){return m.hasProtocol(m.clean(a))},hasProtocol:function(a){return/^(:?\w+:)/.test(a)},isRelative:function(a){return/^[^\/|#]/.test(a)&&
!m.hasProtocol(a)},isEmbeddedPage:function(a){return/^#/.test(a)}},l=null,h={stack:[],activeIndex:0,getActive:function(){return h.stack[h.activeIndex]},getPrev:function(){return h.stack[h.activeIndex-1]},getNext:function(){return h.stack[h.activeIndex+1]},addNew:function(a,b,c,d){h.getNext()&&h.clearForward();h.stack.push({url:a,transition:b,title:c,page:d});h.activeIndex=h.stack.length-1},clearForward:function(){h.stack=h.stack.slice(0,h.activeIndex+1)},directHashChange:function(b){var d,e,f;a.each(h.stack,
function(a,c){b.currentUrl===c.url&&(d=a<h.activeIndex,e=!d,f=a)});this.activeIndex=f!==c?f:this.activeIndex;d?b.isBack():e&&b.isForward()},ignoreNextHashChange:!1},o="[tabindex],a,button:visible,select:visible,input",n=[],q=!1,u="&ui-state=dialog",v=k.children("base"),w=location.protocol+"//"+location.host,x=w+location.pathname;if(v.length){var s=v.attr("href");s&&(s.search(/^[^:\/]+:\/\/[^\/]+\/?/)===-1?w+=s:w=s);w+=w.charAt(w.length-1)==="/"?" ":"/"}var r=a.support.dynamicBaseTag?{element:v.length?
v:a("<base>",{href:x}).prependTo(k),set:function(a){r.element.attr("href",w+m.get(a))},reset:function(){r.element.attr("href",x)}}:c;m.setOrigin();a.fn.animationComplete=function(b){return a.support.cssTransitions?a(this).one("webkitAnimationEnd",b):(setTimeout(b,0),a(this))};a.mobile.updateHash=m.set;a.mobile.path=m;a.mobile.base=r;a.mobile.urlstack=h.stack;a.mobile.urlHistory=h;a.mobile.noneTransitionHandler=function(b,c,d,e){e&&e.removeClass(a.mobile.activePageClass);d.addClass(a.mobile.activePageClass);
return a.Deferred().resolve(b,c,d,e).promise()};a.mobile.defaultTransitionHandler=a.mobile.noneTransitionHandler;a.mobile.transitionHandlers={none:a.mobile.defaultTransitionHandler};a.mobile.allowCrossDomainPages=!1;a.mobile.loadPage=function(b,d){var e=a.Deferred(),h=a.extend({},a.mobile.loadPage.defaults,d),g=b,j=m.getFilePath(g),k=null,l=null;h.pageContainer=h.pageContainer||a.mobile.pageContainer;if(h.data&&h.type==="get"){if(a.type(h.data)==="object")h.data=a.param(h.data);b+=b+"?"+h.data;h.data=
c}k=h.pageContainer.children(":jqmData(url='"+g+"')");r&&r.reset();if(k.length){if(!h.reloadPage)return f(k,h.role),e.resolve(b,d,k),e.promise();l=k}h.showLoadMsg&&a.mobile.showPageLoadingMsg();a.ajax({url:j,type:h.type,data:h.data,dataType:"html",success:function(c){var i=a("<div></div>"),n=c.match(/<title[^>]*>([^<]*)/)&&RegExp.$1,q=RegExp("\\bdata-"+a.mobile.ns+"url=[\"']?([^\"'>]*)[\"']?");RegExp(".*(<[^>]+\\bdata-"+a.mobile.ns+"role=[\"']?page[\"']?[^>]*>).*").test(c)&&RegExp.$1&&q.test(RegExp.$1)&&
RegExp.$1&&(b=j=m.getFilePath(RegExp.$1));r&&r.set(j);i.get(0).innerHTML=c;k=i.find(":jqmData(role='page'), :jqmData(role='dialog')").first();n&&!k.jqmData("title")&&k.jqmData("title",n);if(!a.support.dynamicBaseTag){var o=m.get(j);k.find("[src], link[href], a[rel='external'], :jqmData(ajax='false'), a[target]").each(function(){var b=a(this).is("[href]")?"href":"src",c=a(this).attr(b),c=c.replace(location.protocol+"//"+location.host+location.pathname,"");/^(\w+:|#|\/)/.test(c)||a(this).attr(b,o+c)})}k.attr("data-"+
a.mobile.ns+"url",j).appendTo(h.pageContainer);f(k,h.role);g.indexOf("&"+a.mobile.subPageUrlKey)>-1&&(k=h.pageContainer.children(":jqmData(url='"+g+"')"));h.showLoadMsg&&a.mobile.hidePageLoadingMsg();e.resolve(b,d,k,l)},error:function(){r&&r.set(m.get());h.showLoadMsg&&(a.mobile.hidePageLoadingMsg(),a("<div class='ui-loader ui-overlay-shadow ui-body-e ui-corner-all'><h1>"+a.mobile.pageLoadErrorMessage+"</h1></div>").css({display:"block",opacity:0.96,top:i.scrollTop()+100}).appendTo(h.pageContainer).delay(800).fadeOut(400,
function(){a(this).remove()}));e.reject(b,d)}});return e.promise()};a.mobile.loadPage.defaults={type:"get",data:c,reloadPage:!1,role:"page",showLoadMsg:!0,pageContainer:c};a.mobile.changePage=function(g,i){if(typeof i!=="object"){var k=null;if(typeof g==="object"&&g.url&&g.type)k={type:g.type,data:g.data,forcePageLoad:!0},g=g.url;var l=arguments.length;if(l>1){var o=["transition","reverse","changeHash","fromHashChange"],r;for(r=1;r<l;r++){var v=arguments[r];typeof v!=="undefined"&&(k=k||{},k[o[r-
1]]=v)}}if(k)return a.mobile.changePage(g,k)}if(q)n.unshift(arguments);else{q=!0;var t=a.extend({},a.mobile.changePage.defaults,i);t.pageContainer=t.pageContainer||a.mobile.pageContainer;if(typeof g=="string"&&(k=a.mobile.loadPage(g,t))){k.done(function(b,c,d,e){q=!1;c.duplicateCachedPage=e;a.mobile.changePage(d,c)}).fail(function(){q=!1;d(!0);b()});return}var w=t.pageContainer,k=a.mobile.activePage,l=g.jqmData("url");m.getFilePath(l);var o=h.getActive(),s=0;r=document.title;v=t.role==="dialog"||
g.jqmData("role")==="dialog";w.trigger("beforechangepage");if(o&&o.page[0]===g[0])q=!1;else{f(g,t.role);t.fromHashChange&&h.directHashChange({currentUrl:l,isBack:function(){s=-1},isForward:function(){s=1}});a(document.activeElement||"").add("input:focus, textarea:focus, select:focus").blur();v&&o&&(l=o.url+u);if(t.changeHash!==!1&&l)h.ignoreNextHashChange=!0,m.set(l);(v=g.jqmData("title")||g.children(":jqmData(role='header')").find(".ui-title").text())&&r==document.title&&(r=v);s||h.addNew(l,t.transition,
r,g);document.title=h.getActive().title;a.mobile.activePage=g;t.transition=t.transition||(s?o.transition:c)||(t.role==="dialog"?a.mobile.defaultDialogTransition:a.mobile.defaultPageTransition);t.reverse=t.reverse||s<0;k=e(g,k,t.transition,t.reverse,t.changeHash);k.done(function(){d();t.duplicateCachedPage&&t.duplicateCachedPage.remove();j.removeClass("ui-mobile-rendering");b();w.trigger("changepage")})}}};a.mobile.changePage.defaults={transition:c,reverse:!1,changeHash:!0,fromHashChange:!1,role:"page",
duplicateCachedPage:c,pageContainer:c};a("form").live("submit",function(b){var c=a(this);if(a.mobile.ajaxEnabled&&!c.is(":jqmData(ajax='false')")){var d=c.attr("method"),e=m.clean(c.attr("action")),f=c.attr("target");!m.isExternal(e)&&!f&&(m.isRelative(e)&&(e=m.makeAbsolute(e)),a.mobile.changePage(e.length&&e||m.get(),{type:d.length&&d.toLowerCase()||"get",data:c.serialize(),transition:c.jqmData("transition"),direction:c.jqmData("direction"),reloadPage:!0}),b.preventDefault())}});a(document).bind("vclick",
function(b){if(b=g(b.target)){var c=m.clean(b.getAttribute("href")||"#");c!=="#"&&c.replace(m.get(),"")!=="#"&&a(b).closest(".ui-btn").not(".ui-disabled").addClass(a.mobile.activeBtnClass)}});a(document).bind("click",function(b){var c=g(b.target);if(c){var e=a(c),f=e.attr("href")||"#",c=m.hasProtocol(f),f=m.clean(f),h=e.is("[rel='external']"),i=m.isEmbeddedPage(f),j=a.mobile.allowCrossDomainPages&&location.protocol==="file:"&&f.search(/^https?:/)!=-1,h=m.isExternal(f)&&!j||h&&!i,i=e.is("[target]"),
j=e.is(":jqmData(ajax='false')");if(e.is(":jqmData(rel='back')"))return window.history.back(),!1;f.replace(m.get(),"")=="#"?b.preventDefault():(l=e.closest(".ui-btn"),h||j||i||!a.mobile.ajaxEnabled?window.setTimeout(function(){d(!0)},200):(h=e.jqmData("transition"),i=(i=e.jqmData("direction"))&&i==="reverse"||e.jqmData("back"),e=e.attr("data-"+a.mobile.ns+"rel")||"page",m.isRelative(f)&&!c&&(f=m.makeAbsolute(f)),f=m.stripHash(f),a.mobile.changePage(f,{transition:h,reverse:i,role:e}),b.preventDefault()))}});
i.bind("hashchange",function(){var b=m.stripHash(location.hash),d=a.mobile.urlHistory.stack.length===0?"none":c;if(!a.mobile.hashListeningEnabled||h.ignoreNextHashChange)h.ignoreNextHashChange=!1;else{if(h.stack.length>1&&b.indexOf(u)>-1)if(a.mobile.activePage.is(".ui-dialog")){var e=function(){b=a.mobile.urlHistory.getActive().page};h.directHashChange({currentUrl:b,isBack:e,isForward:e})}else{h.directHashChange({currentUrl:b,isBack:function(){window.history.back()},isForward:function(){window.history.forward()}});
return}b?a.mobile.changePage(b,{transition:d,changeHash:!1,fromHashChange:!0}):a.mobile.changePage(a.mobile.firstPage,{transition:d,changeHash:!1,fromHashChange:!0})}})})(jQuery);
(function(a){function c(c,b,e,f){var g=new a.Deferred,i=b?" reverse":"",j="ui-mobile-viewport-transitioning viewport-"+c;e.animationComplete(function(){e.add(f).removeClass("out in reverse "+c);f&&f.removeClass(a.mobile.activePageClass);e.parent().removeClass(j);g.resolve(c,b,e,f)});e.parent().addClass(j);f&&f.addClass(c+" out"+i);e.addClass(a.mobile.activePageClass+" "+c+" in"+i);return g.promise()}a.mobile.css3TransitionHandler=c;if(a.mobile.defaultTransitionHandler===a.mobile.noneTransitionHandler)a.mobile.defaultTransitionHandler=
c})(jQuery,this);
(function(a,c){a.fn.fixHeaderFooter=function(){if(!a.support.scrollTop)return this;return this.each(function(){var c=a(this);c.jqmData("fullscreen")&&c.addClass("ui-page-fullscreen");c.find(".ui-header:jqmData(position='fixed')").addClass("ui-header-fixed ui-fixed-inline fade");c.find(".ui-footer:jqmData(position='fixed')").addClass("ui-footer-fixed ui-fixed-inline fade")})};a.fixedToolbars=function(){function d(){!g&&f=="overlay"&&(i||a.fixedToolbars.hide(!0),a.fixedToolbars.startShowTimer())}function b(a){var b=
0;if(a)for(var c=a.offsetParent,d=document.body,b=a.offsetTop;a&&a!=d;){b+=a.scrollTop||0;if(a==c)b+=c.offsetTop,c=a.offsetParent;a=a.parentNode}return b}function e(c){var d=a(window).scrollTop(),e=b(c[0]),f=c.css("top")=="auto"?0:parseFloat(c.css("top")),g=window.innerHeight,i=c.outerHeight(),j=c.parents(".ui-page:not(.ui-page-fullscreen)").length;return c.is(".ui-header-fixed")?(f=d-e+f,f<e&&(f=0),c.css("top",j?f:d)):c.css("top",j?d+g-i-(e-f):d+g-i)}if(a.support.scrollTop){var f="inline",g=!1,i,
j,k=null,m=!1,l=!0;a(function(){a(document).bind("vmousedown",function(){l&&(k=f)}).bind("vclick",function(b){l&&!a(b.target).closest("a,input,textarea,select,button,label,.ui-header-fixed,.ui-footer-fixed").length&&!m&&(a.fixedToolbars.toggle(k),k=null)}).bind("silentscroll",d);(a(document).scrollTop()==0?a(window):a(document)).bind("scrollstart",function(){m=!0;k==null&&(k=f);var b=k=="overlay";if(g=b||!!i)a.fixedToolbars.clearShowTimer(),b&&a.fixedToolbars.hide(!0)}).bind("scrollstop",function(b){a(b.target).closest("a,input,textarea,select,button,label,.ui-header-fixed,.ui-footer-fixed").length||
...
a.fixedToolbars.show(!0,this)});a(".ui-collapsible-contain").live("collapse expand",d);return{show:function(c,d){a.fixedToolbars.clearShowTimer();f="overlay";return(d?a(d):a.mobile.activePage?a.mobile.activePage:a(".ui-page-active")).children(".ui-header-fixed:first, .ui-footer-fixed:not(.ui-footer-duplicate):last").each(function(){var d=a(this),f=a(window).scrollTop(),g=b(d[0]),i=window.innerHeight,j=d.outerHeight(),f=d.is(".ui-header-fixed")&&f<=g+j||d.is(".ui-footer-fixed")&&g<=f+i;d.addClass("ui-fixed-overlay").removeClass("ui-fixed-inline");
...
0&&c.animationComplete(function(){c.removeClass("out reverse");c.css("top",0)}).addClass("out reverse")})},startShowTimer:function(){a.fixedToolbars.clearShowTimer();var b=a.makeArray(arguments);i=setTimeout(function(){i=c;a.fixedToolbars.show.apply(null,b)},100)},clearShowTimer:function(){i&&clearTimeout(i);i=c},toggle:function(b){b&&(f=b);return f=="overlay"?a.fixedToolbars.hide():a.fixedToolbars.show()},setTouchToggleEnabled:function(a){l=a}}}}()})(jQuery);
...
if(c.is("textarea")){var g=function(){var a=c[0].scrollHeight;c[0].clientHeight<a&&c.css({height:a+15})},i;c.keyup(function(){clearTimeout(i);i=setTimeout(g,100)})}},disable:function(){(this.element.attr("disabled",!0).is("[type='search'],:jqmData(type='search')")?this.element.parent():this.element).addClass("ui-disabled")},enable:function(){(this.element.attr("disabled",!1).is("[type='search'],:jqmData(type='search')")?this.element.parent():this.element).removeClass("ui-disabled")}})})(jQuery);
(function(a){a.widget("mobile.selectmenu",a.mobile.widget,{options:{theme:null,disabled:!1,icon:"arrow-d",iconpos:"right",inline:null,corners:!0,shadow:!0,iconshadow:!0,menuPageTheme:"b",overlayTheme:"a",hidePlaceholderMenuItems:!0,closeText:"Close",nativeMenu:!0},_create:function(){var c=this,d=this.options,b=this.element.wrap("<div class='ui-select'>"),e=b.attr("id"),f=a('label[for="'+e+'"]').addClass("ui-select"),g=b[0].selectedIndex==-1?0:b[0].selectedIndex,i=(c.options.nativeMenu?a("<div/>"):
a("<a>",{href:"#",role:"button",id:m,"aria-haspopup":"true","aria-owns":l})).text(a(b[0].options.item(g)).text()).insertBefore(b).buttonMarkup({theme:d.theme,icon:d.icon,iconpos:d.iconpos,inline:d.inline,corners:d.corners,shadow:d.shadow,iconshadow:d.iconshadow}),j=c.isMultiple=b[0].multiple;d.nativeMenu&&window.opera&&window.opera.version&&b.addClass("ui-select-nativeonly");if(!d.nativeMenu){var k=b.find("option"),m=e+"-button",l=e+"-menu",h=b.closest(".ui-page"),g=/ui-btn-up-([a-z])/.exec(i.attr("class"))[1],
o=a("<div data-"+a.mobile.ns+"role='dialog' data-"+a.mobile.ns+"theme='"+d.menuPageTheme+"'><div data-"+a.mobile.ns+"role='header'><div class='ui-title'>"+f.text()+"</div></div><div data-"+a.mobile.ns+"role='content'></div></div>").appendTo(a.mobile.pageContainer).page(),n=o.find(".ui-content");o.find(".ui-header a");var q=a("<div>",{"class":"ui-selectmenu-screen ui-screen-hidden"}).appendTo(h),u=a("<div>",{"class":"ui-selectmenu ui-selectmenu-hidden ui-overlay-shadow ui-corner-all pop ui-body-"+
d.overlayTheme}).insertAfter(q),v=a("<ul>",{"class":"ui-selectmenu-list",id:l,role:"listbox","aria-labelledby":m}).attr("data-"+a.mobile.ns+"theme",g).appendTo(u),w=a("<div>",{"class":"ui-header ui-bar-"+g}).prependTo(u),x=a("<h1>",{"class":"ui-title"}).appendTo(w),s=a("<a>",{text:d.closeText,href:"#","class":"ui-btn-left"}).attr("data-"+a.mobile.ns+"iconpos","notext").attr("data-"+a.mobile.ns+"icon","delete").appendTo(w).buttonMarkup()}if(j)c.buttonCount=a("<span>").addClass("ui-li-count ui-btn-up-c ui-btn-corner-all").hide().appendTo(i);
d.disabled&&this.disable();b.change(function(){c.refresh()});a.extend(c,{select:b,optionElems:k,selectID:e,label:f,buttonId:m,menuId:l,thisPage:h,button:i,menuPage:o,menuPageContent:n,screen:q,listbox:u,list:v,menuType:void 0,header:w,headerClose:s,headerTitle:x,placeholder:""});d.nativeMenu?b.appendTo(i).bind("vmousedown",function(){i.addClass(a.mobile.activeBtnClass)}).bind("focus vmouseover",function(){i.trigger("vmouseover")}).bind("vmousemove",function(){i.removeClass(a.mobile.activeBtnClass)}).bind("change blur vmouseout",
function(){i.trigger("vmouseout").removeClass(a.mobile.activeBtnClass)}):(c.refresh(),b.attr("tabindex","-1").focus(function(){a(this).blur();i.focus()}),i.bind("vclick keydown",function(b){if(b.type=="vclick"||b.keyCode&&(b.keyCode===a.mobile.keyCode.ENTER||b.keyCode===a.mobile.keyCode.SPACE))c.open(),b.preventDefault()}),v.attr("role","listbox").delegate(".ui-li>a","focusin",function(){a(this).attr("tabindex","0")}).delegate(".ui-li>a","focusout",function(){a(this).attr("tabindex","-1")}).delegate("li:not(.ui-disabled, .ui-li-divider)",
"vclick",function(d){var e=b[0].selectedIndex,f=v.find("li:not(.ui-li-divider)").index(this),g=c.optionElems.eq(f)[0];g.selected=j?!g.selected:!0;j&&a(this).find(".ui-icon").toggleClass("ui-icon-checkbox-on",g.selected).toggleClass("ui-icon-checkbox-off",!g.selected);e!==f&&b.trigger("change");j||c.close();d.preventDefault()}).keydown(function(b){var c=a(b.target),d=c.closest("li");switch(b.keyCode){case 38:return b=d.prev(),b.length&&(c.blur().attr("tabindex","-1"),b.find("a").first().focus()),!1;
case 40:return b=d.next(),b.length&&(c.blur().attr("tabindex","-1"),b.find("a").first().focus()),!1;case 13:case 32:return c.trigger("vclick"),!1}}),q.bind("vclick",function(){c.close()}),c.headerClose.click(function(){if(c.menuType=="overlay")return c.close(),!1}))},_buildList:function(){var c=this,d=this.options,b=this.placeholder,e=[],f=[],g=c.isMultiple?"checkbox-off":"false";c.list.empty().filter(".ui-listview").listview("destroy");c.select.find("option").each(function(){var i=a(this),j=i.parent(),
k=i.text(),m="<a href='#'>"+k+"</a>",l=[],h=[];j.is("optgroup")&&(j=j.attr("label"),a.inArray(j,e)===-1&&(f.push("<li data-"+a.mobile.ns+"role='list-divider'>"+j+"</li>"),e.push(j)));if(!this.getAttribute("value")||k.length==0||i.jqmData("placeholder"))d.hidePlaceholderMenuItems&&l.push("ui-selectmenu-placeholder"),b=c.placeholder=k;this.disabled&&(l.push("ui-disabled"),h.push("aria-disabled='true'"));f.push("<li data-"+a.mobile.ns+"icon='"+g+"' class='"+l.join(" ")+"' "+h.join(" ")+">"+m+"</li>")});
c.list.html(f.join(" "));c.list.find("li").attr({role:"option",tabindex:"-1"}).first().attr("tabindex","0");this.isMultiple||this.headerClose.hide();!this.isMultiple&&!b.length?this.header.hide():this.headerTitle.text(this.placeholder);c.list.listview()},refresh:function(c){var d=this,b=this.element,e=this.isMultiple,f=this.optionElems=b.find("option"),g=f.filter(":selected"),i=g.map(function(){return f.index(this)}).get();!d.options.nativeMenu&&(c||b[0].options.length!=d.list.find("li").length)&&
...
open:function(){function c(){d.list.find(".ui-btn-active").focus()}if(!this.options.disabled&&!this.options.nativeMenu){var d=this,b=d.list.parent().outerHeight(),e=d.list.parent().outerWidth(),f=a(window).scrollTop(),g=d.button.offset().top,i=window.innerHeight,j=window.innerWidth;d.button.addClass(a.mobile.activeBtnClass);setTimeout(function(){d.button.removeClass(a.mobile.activeBtnClass)},300);if(b>i-80||!a.support.scrollTop){if(f==0&&g>i)d.thisPage.one("pagehide",function(){a(this).jqmData("lastScroll",
g)});d.menuPage.one("pageshow",function(){a(window).one("silentscroll",function(){c()})});d.menuType="page";d.menuPageContent.append(d.list);a.mobile.changePage(d.menuPage,{transition:"pop"})}else{d.menuType="overlay";d.screen.height(a(document).height()).removeClass("ui-screen-hidden");var k=g-f,m=f+i-g,l=b/2,h=parseFloat(d.list.parent().css("max-width")),b=k>b/2&&m>b/2?g+d.button.outerHeight()/2-l:k>m?f+i-b-30:f+30;e<h?h=(j-e)/2:(h=d.button.offset().left+d.button.outerWidth()/2-e/2,h<30?h=30:h+
e>j&&(h=j-e-30));d.listbox.append(d.list).removeClass("ui-selectmenu-hidden").css({top:b,left:h}).addClass("in");c()}setTimeout(function(){d.isOpen=!0},400)}},close:function(){function a(){setTimeout(function(){d.button.focus()},40);d.listbox.removeAttr("style").append(d.list)}if(!this.options.disabled&&this.isOpen&&!this.options.nativeMenu){var d=this;d.menuType=="page"?(d.menuPage.one("pagehide",a),window.history.back()):(d.screen.addClass("ui-screen-hidden"),d.listbox.addClass("ui-selectmenu-hidden").removeAttr("style").removeClass("in"),
...
(function(a){function c(b){for(;b;){var c=a(b);if(c.hasClass("ui-btn")&&!c.hasClass("ui-disabled"))break;b=b.parentNode}return b}a.fn.buttonMarkup=function(b){return this.each(function(){var c=a(this),f=a.extend({},a.fn.buttonMarkup.defaults,c.jqmData(),b),g,i="ui-btn-inner",j;d&&d();if(!f.theme)g=c.closest("[class*='ui-bar-'],[class*='ui-body-']"),f.theme=g.length?/ui-(bar|body)-([a-z])/.exec(g.attr("class"))[2]:"c";g="ui-btn ui-btn-up-"+f.theme;f.inline&&(g+=" ui-btn-inline");if(f.icon)f.icon="ui-icon-"+
f.icon,f.iconpos=f.iconpos||"left",j="ui-icon "+f.icon,f.shadow&&(j+=" ui-icon-shadow");f.iconpos&&(g+=" ui-btn-icon-"+f.iconpos,f.iconpos=="notext"&&!c.attr("title")&&c.attr("title",c.text()));f.corners&&(g+=" ui-btn-corner-all",i+=" ui-btn-corner-all");f.shadow&&(g+=" ui-shadow");c.attr("data-"+a.mobile.ns+"theme",f.theme).addClass(g);f=("<D class='"+i+"'><D class='ui-btn-text'></D>"+(f.icon?"<span class='"+j+"'></span>":"")+"</D>").replace(/D/g,f.wrapperEls);c.wrapInner(f)})};a.fn.buttonMarkup.defaults=
...
(function(a){a.widget("mobile.slider",a.mobile.widget,{options:{theme:null,trackTheme:null,disabled:!1},_create:function(){var c=this,d=this.element,b=d.parents("[class*=ui-bar-],[class*=ui-body-]").eq(0),b=b.length?b.attr("class").match(/ui-(bar|body)-([a-z])/)[2]:"c",e=this.options.theme?this.options.theme:b,f=this.options.trackTheme?this.options.trackTheme:b,g=d[0].nodeName.toLowerCase(),b=g=="select"?"ui-slider-switch":"",i=d.attr("id"),j=i+"-label",i=a('[for="'+i+'"]').attr("id",j),k=function(){return g==
"input"?parseFloat(d.val()):d[0].selectedIndex},m=g=="input"?parseFloat(d.attr("min")):0,l=g=="input"?parseFloat(d.attr("max")):d.find("option").length-1,h=window.parseFloat(d.attr("step")||1),o=a('<div class="ui-slider '+b+" ui-btn-down-"+f+' ui-btn-corner-all" role="application"></div>'),n=a('<a href="#" class="ui-slider-handle"></a>').appendTo(o).buttonMarkup({corners:!0,theme:e,shadow:!0}).attr({role:"slider","aria-valuemin":m,"aria-valuemax":l,"aria-valuenow":k(),"aria-valuetext":k(),title:k(),
...
!c._keySliding)c._keySliding=!0,a(this).addClass("ui-state-active")}switch(b.keyCode){case a.mobile.keyCode.HOME:c.refresh(m);break;case a.mobile.keyCode.END:c.refresh(l);break;case a.mobile.keyCode.PAGE_UP:case a.mobile.keyCode.UP:case a.mobile.keyCode.RIGHT:c.refresh(d+h);break;case a.mobile.keyCode.PAGE_DOWN:case a.mobile.keyCode.DOWN:case a.mobile.keyCode.LEFT:c.refresh(d-h)}}}).keyup(function(){if(c._keySliding)c._keySliding=!1,a(this).removeClass("ui-state-active")});this.refresh()},refresh:function(a,
d,b){if(!this.options.disabled){var e=this.element,f=e[0].nodeName.toLowerCase(),g=f==="input"?parseFloat(e.attr("min")):0,i=f==="input"?parseFloat(e.attr("max")):e.find("option").length-1;if(typeof a==="object"){if(!this.dragging||a.pageX<this.slider.offset().left-8||a.pageX>this.slider.offset().left+this.slider.width()+8)return;a=Math.round((a.pageX-this.slider.offset().left)/this.slider.width()*100)}else a==null&&(a=f==="input"?parseFloat(e.val()):e[0].selectedIndex),a=(parseFloat(a)-g)/(i-g)*
100;if(!isNaN(a)){a<0&&(a=0);a>100&&(a=100);var j=Math.round(a/100*(i-g))+g;j<g&&(j=g);j>i&&(j=i);this.handle.css("left",a+"%");this.handle.attr({"aria-valuenow":f==="input"?j:e.find("option").eq(j).attr("value"),"aria-valuetext":f==="input"?j:e.find("option").eq(j).text(),title:j});f==="select"&&(j===0?this.slider.addClass("ui-slider-switch-a").removeClass("ui-slider-switch-b"):this.slider.addClass("ui-slider-switch-b").removeClass("ui-slider-switch-a"));if(!b)f==="input"?e.val(j):e[0].selectedIndex=
...
"ui-li-has-icon":"ui-li-has-thumb")}).end().find(".ui-li-aside").each(function(){var b=a(this);b.prependTo(b.parent())})},_removeCorners:function(a){a.add(a.find(".ui-btn-inner, .ui-li-link-alt, .ui-li-thumb")).removeClass("ui-corner-top ui-corner-bottom ui-corner-br ui-corner-bl ui-corner-tr ui-corner-tl")},refresh:function(c){this._createSubPages();var d=this.options,b=this.element,e=b.jqmData("dividertheme")||d.dividerTheme,f=b.jqmData("splittheme"),g=b.jqmData("spliticon"),i=b.children("li"),
j=a.support.cssPseudoElement||!a.nodeName(b[0],"ol")?0:1;j&&b.find(".ui-li-dec").remove();for(var k=0,m=i.length;k<m;k++){var l=i.eq(k),h="ui-li";if(c||!l.hasClass("ui-li")){var o=l.jqmData("theme")||d.theme,n=l.children("a");if(n.length){var q=l.jqmData("icon");l.buttonMarkup({wrapperEls:"div",shadow:!1,corners:!1,iconpos:"right",icon:n.length>1||q===!1?!1:q||"arrow-r",theme:o});n.first().addClass("ui-link-inherit");n.length>1&&(h+=" ui-li-has-alt",n=n.last(),q=f||n.jqmData("theme")||d.splitTheme,
n.appendTo(l).attr("title",n.text()).addClass("ui-li-link-alt").empty().buttonMarkup({shadow:!1,corners:!1,theme:o,icon:!1,iconpos:!1}).find(".ui-btn-inner").append(a("<span />").buttonMarkup({shadow:!0,corners:!0,theme:q,iconpos:"notext",icon:g||n.jqmData("icon")||d.splitIcon})))}else l.jqmData("role")==="list-divider"?(h+=" ui-li-divider ui-btn ui-bar-"+e,l.attr("role","heading"),j&&(j=1)):h+=" ui-li-static ui-body-"+o;d.inset&&(k===0&&(h+=" ui-corner-top",l.add(l.find(".ui-btn-inner")).find(".ui-li-link-alt").addClass("ui-corner-tr").end().find(".ui-li-thumb").addClass("ui-corner-tl"),
l.next().next().length&&this._removeCorners(l.next())),k===i.length-1&&(h+=" ui-corner-bottom",l.add(l.find(".ui-btn-inner")).find(".ui-li-link-alt").addClass("ui-corner-br").end().find(".ui-li-thumb").addClass("ui-corner-bl"),l.prev().prev().length&&this._removeCorners(l.prev())));j&&h.indexOf("ui-li-divider")<0&&(l.is(".ui-li-static:first")?l:l.find(".ui-link-inherit")).addClass("ui-li-jsnumbering").prepend("<span class='ui-li-dec'>"+j++ +". </span>");l.add(l.find(".ui-btn-inner")).addClass(h);
c||this._itemApply(b,l)}}},_idStringEscape:function(a){return a.replace(/[^a-zA-Z0-9]/g,"-")},_createSubPages:function(){var c=this.element,d=c.closest(".ui-page"),b=d.jqmData("url"),e=this.options,f="data-"+a.mobile.ns,g=this,i=d.find(":jqmData(role='footer')").jqmData("id");a(c.find("li>ul, li>ol").toArray().reverse()).each(function(d){var k=a(this),m=k.parent(),l=a(k.prevAll().toArray().reverse()),l=l.length?l:a("<span>"+a.trim(m.contents()[0].nodeValue)+"</span>"),h=l.first().text(),d=b+"&"+a.mobile.subPageUrlKey+
"="+g._idStringEscape(h+" "+d),o=k.jqmData("theme")||e.theme,n=k.jqmData("counttheme")||c.jqmData("counttheme")||e.countTheme;k.detach().wrap("<div "+f+"role='page' "+f+"url='"+d+"' "+f+"theme='"+o+"' "+f+"count-theme='"+n+"'><div "+f+"role='content'></div></div>").parent().before("<div "+f+"role='header' "+f+"theme='"+e.headerTheme+"'><div class='ui-title'>"+h+"</div></div>").after(i?a("<div "+f+"role='footer' "+f+"id='"+i+"'>"):"").parent().appendTo(a.mobile.pageContainer).page();k=m.find("a:first");
k.length||(k=a("<a />").html(l||h).prependTo(m.empty()));k.attr("href","#"+d)}).listview()}})})(jQuery);
...
d=null,d=a(this).jqmData("lastval")+"";a(this).jqmData("lastval",b);change=b.replace(RegExp("^"+d),"");d=b.length<d.length||change.length!=b.length-d.length?c.children():c.children(":not(.ui-screen-hidden)");if(b){for(var g,i=!1,j="",k=d.length;k>=0;k--)g=a(d[k]),j=g.jqmData("filtertext")||g.text(),g.is("li:jqmData(role=list-divider)")?(g.toggleClass("ui-filter-hidequeue",!i),i=!1):j.toLowerCase().indexOf(b)===-1?g.toggleClass("ui-filter-hidequeue",!0):i=!0;d.filter(":not(.ui-filter-hidequeue)").toggleClass("ui-screen-hidden",
