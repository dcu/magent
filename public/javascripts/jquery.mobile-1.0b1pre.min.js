 ...
 * Git Info SHA1: 6ac1598033644859f4ffb2c65bf759c651304963 Date: Thu May 26 13:04:37 2011 -0700
...
(function(a,c,d,b){function e(a){for(;a&&typeof a.originalEvent!=="undefined";)a=a.originalEvent;return a}function f(b){for(var c={};b;){var d=a.data(b,r),e;for(e in d)if(d[e])c[e]=c.hasVirtualBinding=!0;b=b.parentNode}return c}function g(){s&&(clearTimeout(s),s=0);s=setTimeout(function(){x=s=0;z.length=0;C=!1;y=!0},a.vmouse.resetTimerDuration)}function h(c,d,f){var i=!1,g;if(!(g=f&&f[c])){if(f=!f)a:{for(f=d.target;f;){if((g=a.data(f,r))&&(!c||g[c]))break a;f=f.parentNode}f=null}g=f}if(g){i=d;f=i.type;
i=a.Event(i);i.type=c;var h=i.originalEvent,j=a.event.props;if(h)for(c=j.length;c;)g=j[--c],i[g]=h[g];if(f.search(/^touch/)!==-1&&(c=e(h),f=c.touches,c=c.changedTouches,f=f&&f.length?f[0]:c&&c.length?c[0]:b)){c=0;for(h=q.length;c<h;c++)g=q[c],i[g]=f[g]}a(d.target).trigger(i);i=i.isDefaultPrevented()}return i}function j(b){var c=a.data(b.target,v);!C&&(!x||x!==c)&&h("v"+b.type,b)}function k(b){var c=e(b).touches;if(c&&c.length===1){var d=b.target,c=f(d);if(c.hasVirtualBinding)x=F++,a.data(d,v,x),s&&
(clearTimeout(s),s=0),w=y=!1,d=e(b).touches[0],t=d.pageX,E=d.pageY,h("vmouseover",b,c),h("vmousedown",b,c)}}function m(a){y||(w||h("vmousecancel",a,f(a.target)),w=!0,g())}function l(b){if(!y){var c=e(b).touches[0],d=w,i=a.vmouse.moveDistanceThreshold;w=w||Math.abs(c.pageX-t)>i||Math.abs(c.pageY-E)>i;c=f(b.target);w&&!d&&h("vmousecancel",b,c);h("vmousemove",b,c);g()}}function i(a){if(!y){y=!0;var b=f(a.target);h("vmouseup",a,b);if(!w&&h("vclick",a,b)){var c=e(a).changedTouches[0];z.push({touchID:x,
x:c.clientX,y:c.clientY});C=!0}h("vmouseout",a,b);w=!1;g()}}function o(b){var b=a.data(b,r),c;if(b)for(c in b)if(b[c])return!0;return!1}function n(){}function p(b){var c=b.substr(1);return{setup:function(){o(this)||a.data(this,r,{});a.data(this,r)[b]=!0;u[b]=(u[b]||0)+1;u[b]===1&&A.bind(c,j);a(this).bind(c,n);if(D)u.touchstart=(u.touchstart||0)+1,u.touchstart===1&&A.bind("touchstart",k).bind("touchend",i).bind("touchmove",l).bind("scroll",m)},teardown:function(){--u[b];u[b]||A.unbind(c,j);D&&(--u.touchstart,
u.touchstart||A.unbind("touchstart",k).unbind("touchmove",l).unbind("touchend",i).unbind("scroll",m));var d=a(this),e=a.data(this,r);e&&(e[b]=!1);d.unbind(c,n);o(this)||d.removeData(r)}}}var r="virtualMouseBindings",v="virtualTouchID",c="vmouseover vmousedown vmousemove vmouseup vclick vmouseout vmousecancel".split(" "),q="clientX clientY pageX pageY screenX screenY".split(" "),u={},s=0,t=0,E=0,w=!1,z=[],C=!1,y=!1,D=a.support.eventCapture,A=a(d),F=1,x=0;a.vmouse={moveDistanceThreshold:10,clickDistanceThreshold:10,
resetTimerDuration:1500};for(var B=0;B<c.length;B++)a.event.special[c[B]]=p(c[B]);D&&d.addEventListener("click",function(b){var c=z.length,d=b.target;if(c)for(var e=b.clientX,f=b.clientY,i=a.vmouse.clickDistanceThreshold,g=d;g;){for(var h=0;h<c;h++){var j=z[h];if(g===d&&Math.abs(j.x-e)<i&&Math.abs(j.y-f)<i||a.data(g,v)===j.touchID){b.preventDefault();b.stopPropagation();return}}g=g.parentNode}},!0)})(jQuery,window,document);
...
(function(a,c,d){function b(a){a=a||location.href;return"#"+a.replace(/^[^#]*#?(.*)$/,"$1")}var e="hashchange",f=document,g,h=a.event.special,j=f.documentMode,k="on"+e in c&&(j===d||j>7);a.fn[e]=function(a){return a?this.bind(e,a):this.trigger(e)};a.fn[e].delay=50;h[e]=a.extend(h[e],{setup:function(){if(k)return!1;a(g.start)},teardown:function(){if(k)return!1;a(g.stop)}});g=function(){function g(){var d=b(),f=r(j);if(d!==j)p(j=d,f),a(c).trigger(e);else if(f!==j)location.href=location.href.replace(/#.*/,
"")+f;i=setTimeout(g,a.fn[e].delay)}var h={},i,j=b(),n=function(a){return a},p=n,r=n;h.start=function(){i||g()};h.stop=function(){i&&clearTimeout(i);i=d};a.browser.msie&&!k&&function(){var c,d;h.start=function(){if(!c)d=(d=a.fn[e].src)&&d+b(),c=a('<iframe tabindex="-1" title="empty"/>').hide().one("load",function(){d||p(b());g()}).attr("src",d||"javascript:0").insertAfter("body")[0].contentWindow,f.onpropertychange=function(){try{if(event.propertyName==="title")c.document.title=f.title}catch(a){}}};
h.stop=n;r=function(){return b(c.location.href)};p=function(b,d){var g=c.document,i=a.fn[e].domain;if(b!==d)g.title=f.title,g.open(),i&&g.write('<script>document.domain="'+i+'"<\/script>'),g.close(),c.location.hash=b}}();return h}()})(jQuery,this);
...
"a")break;a=a.parentNode}return a}var h=a(window),j=a("html"),k=a("head"),m={get:function(a){if(a===c)a=location.hash;return m.stripHash(a).replace(/[^\/]*\.[^\/*]+$/,"")},getFilePath:function(b){var c="&"+a.mobile.subPageUrlKey;return b&&b.split(c)[0].split(r)[0]},set:function(a){location.hash=a},origin:"",setOrigin:function(){m.origin=m.get(location.protocol+"//"+location.host+location.pathname)},makeAbsolute:function(a){var b=m.isPath(location.hash);if(m.isQuery(a))return(b?m.cleanHash(location.hash):
location.pathname)+a;return(b?m.get():m.get(location.pathname))+a},isPath:function(a){return/\//.test(a)},isQuery:function(a){return/^\?/.test(a)},clean:function(a){return a.replace(RegExp("^"+location.protocol+"//"+location.host),"")},stripHash:function(a){return a.replace(/^#/,"")},cleanHash:function(a){return m.stripHash(a.replace(/\?.*$/,"").replace(r,""))},isExternal:function(a){return m.hasProtocol(m.clean(a))},hasProtocol:function(a){return/^(:?\w+:)/.test(a)},isRelative:function(a){return/^[^\/|#]/.test(a)&&
...
function(a,c){b.currentUrl===c.url&&(d=a<i.activeIndex,e=!d,f=a)});this.activeIndex=f!==c?f:this.activeIndex;d?b.isBack():e&&b.isForward()},ignoreNextHashChange:!1},o="[tabindex],a,button:visible,select:visible,input",n=[],p=!1,r="&ui-state=dialog",v=k.children("base"),q=location.protocol+"//"+location.host,u=q+location.pathname;if(v.length){var s=v.attr("href");s&&(s.search(/^[^:\/]+:\/\/[^\/]+\/?/)===-1?q+=s:q=s);q+=q.charAt(q.length-1)==="/"?" ":"/"}var t=a.support.dynamicBaseTag?{element:v.length?
v:a("<base>",{href:u}).prependTo(k),set:function(a){t.element.attr("href",q+m.get(a))},reset:function(){t.element.attr("href",u)}}:c;m.setOrigin();a.fn.animationComplete=function(b){return a.support.cssTransitions?a(this).one("webkitAnimationEnd",b):(setTimeout(b,0),a(this))};a.mobile.updateHash=m.set;a.mobile.path=m;a.mobile.base=t;a.mobile.urlstack=i.stack;a.mobile.urlHistory=i;a.mobile.noneTransitionHandler=function(b,c,d,e){e&&e.removeClass(a.mobile.activePageClass);d.addClass(a.mobile.activePageClass);
return a.Deferred().resolve(b,c,d,e).promise()};a.mobile.defaultTransitionHandler=a.mobile.noneTransitionHandler;a.mobile.transitionHandlers={none:a.mobile.defaultTransitionHandler};a.mobile.allowCrossDomainPages=!1;a.mobile.loadPage=function(b,d){var e=a.Deferred(),g=a.extend({},a.mobile.loadPage.defaults,d),i=b,j=m.getFilePath(i),k=null,l=null;g.pageContainer=g.pageContainer||a.mobile.pageContainer;if(g.data&&g.type==="get"){if(a.type(g.data)==="object")g.data=a.param(g.data);b+=b+"?"+g.data;g.data=
c}k=g.pageContainer.children(":jqmData(url='"+i+"')");t&&t.reset();if(k.length){if(!g.reloadPage)return f(k,g.role),e.resolve(b,d,k),e.promise();l=k}g.showLoadMsg&&a.mobile.showPageLoadingMsg();a.ajax({url:j,type:g.type,data:g.data,dataType:"html",success:function(c){var h=a("<div></div>"),n=c.match(/<title[^>]*>([^<]*)/)&&RegExp.$1,p=RegExp("\\bdata-"+a.mobile.ns+"url=[\"']?([^\"'>]*)[\"']?");RegExp(".*(<[^>]+\\bdata-"+a.mobile.ns+"role=[\"']?page[\"']?[^>]*>).*").test(c)&&RegExp.$1&&p.test(RegExp.$1)&&
RegExp.$1&&(b=j=m.getFilePath(RegExp.$1));t&&t.set(j);h.get(0).innerHTML=c;k=h.find(":jqmData(role='page'), :jqmData(role='dialog')").first();n&&!k.jqmData("title")&&k.jqmData("title",n);if(!a.support.dynamicBaseTag){var o=m.get(j);k.find("[src], link[href], a[rel='external'], :jqmData(ajax='false'), a[target]").each(function(){var b=a(this).is("[href]")?"href":"src",c=a(this).attr(b),c=c.replace(location.protocol+"//"+location.host+location.pathname,"");/^(\w+:|#|\/)/.test(c)||a(this).attr(b,o+c)})}k.attr("data-"+
a.mobile.ns+"url",j).appendTo(g.pageContainer);f(k,g.role);i.indexOf("&"+a.mobile.subPageUrlKey)>-1&&(k=g.pageContainer.children(":jqmData(url='"+i+"')"));g.showLoadMsg&&a.mobile.hidePageLoadingMsg();e.resolve(b,d,k,l)},error:function(){t&&t.set(m.get());g.showLoadMsg&&(a.mobile.hidePageLoadingMsg(),a("<div class='ui-loader ui-overlay-shadow ui-body-e ui-corner-all'><h1>"+a.mobile.pageLoadErrorMessage+"</h1></div>").css({display:"block",opacity:0.96,top:h.scrollTop()+100}).appendTo(g.pageContainer).delay(800).fadeOut(400,
function(){a(this).remove()}));e.reject(b,d)}});return e.promise()};a.mobile.loadPage.defaults={type:"get",data:"undefined",reloadPage:!1,role:"page",showLoadMsg:!0,pageContainer:c};a.mobile.changePage=function(g,h){if(p)n.unshift(arguments);else{p=!0;var k=a.extend({},a.mobile.changePage.defaults,h);k.pageContainer=k.pageContainer||a.mobile.pageContainer;if(typeof g=="string"){var l=a.mobile.loadPage(g,k);if(l){l.done(function(b,c,d,e){p=!1;c.duplicateCachedPage=e;a.mobile.changePage(d,c)}).fail(function(){p=
!1;d(!0);b()});return}}var o=k.pageContainer,l=a.mobile.activePage,t=g.jqmData("url");m.getFilePath(t);var v=i.getActive(),q=0,s=document.title,u=k.role==="dialog"||g.jqmData("role")==="dialog";o.trigger("beforechangepage");if(v&&v.page[0]===g[0])p=!1;else{f(g,k.role);k.fromHashChange&&i.directHashChange({currentUrl:t,isBack:function(){q=-1},isForward:function(){q=1}});a(document.activeElement||"").add("input:focus, textarea:focus, select:focus").blur();u&&v&&(t=v.url+r);if(k.changeHash!==!1&&t)i.ignoreNextHashChange=
!0,m.set(t);(u=g.jqmData("title")||g.children(":jqmData(role='header')").find(".ui-title").text())&&s==document.title&&(s=u);q||i.addNew(t,k.transition,s,g);document.title=i.getActive().title;a.mobile.activePage=g;k.transition=k.transition||(q?v.transition:c)||(k.role==="dialog"?a.mobile.defaultDialogTransition:a.mobile.defaultPageTransition);k.reverse=k.reverse||q<0;l=e(g,l,k.transition,k.reverse,k.changeHash);l.done(function(){d();k.duplicateCachedPage&&k.duplicateCachedPage.remove();j.removeClass("ui-mobile-rendering");
b();o.trigger("changepage")})}}};a.mobile.changePage.defaults={transition:c,reverse:!1,changeHash:!0,fromHashChange:!1,role:"page",duplicateCachedPage:c,pageContainer:c};a("form").live("submit",function(b){var c=a(this);if(a.mobile.ajaxEnabled&&!c.is(":jqmData(ajax='false')")){var d=c.attr("method"),e=m.clean(c.attr("action")),f=c.attr("target");!m.isExternal(e)&&!f&&(m.isRelative(e)&&(e=m.makeAbsolute(e)),a.mobile.changePage(e.length&&e||m.get(),{type:d.length&&d.toLowerCase()||"get",data:c.serialize(),
transition:c.jqmData("transition"),direction:c.jqmData("direction"),reloadPage:!0}),b.preventDefault())}});a(document).bind("vclick",function(b){if(b=g(b.target)){var c=m.clean(b.getAttribute("href")||"#");c!=="#"&&c.replace(m.get(),"")!=="#"&&a(b).closest(".ui-btn").not(".ui-disabled").addClass(a.mobile.activeBtnClass)}});a(document).bind("click",function(b){var c=g(b.target);if(c){var e=a(c),f=e.attr("href")||"#",c=m.hasProtocol(f),f=m.clean(f),i=e.is("[rel='external']"),h=m.isEmbeddedPage(f),j=
a.mobile.allowCrossDomainPages&&location.protocol==="file:"&&f.search(/^https?:/)!=-1,i=m.isExternal(f)&&!j||i&&!h,h=e.is("[target]"),j=e.is(":jqmData(ajax='false')");if(e.is(":jqmData(rel='back')"))return window.history.back(),!1;f.replace(m.get(),"")=="#"?b.preventDefault():(l=e.closest(".ui-btn"),i||j||h||!a.mobile.ajaxEnabled?window.setTimeout(function(){d(!0)},200):(i=e.jqmData("transition"),h=(h=e.jqmData("direction"))&&h==="reverse"||e.jqmData("back"),e=e.attr("data-"+a.mobile.ns+"rel")||"page",
m.isRelative(f)&&!c&&(f=m.makeAbsolute(f)),f=m.stripHash(f),a.mobile.changePage(f,{transition:i,reverse:h,role:e}),b.preventDefault()))}});h.bind("hashchange",function(){var b=m.stripHash(location.hash),d=a.mobile.urlHistory.stack.length===0?"none":c;if(!a.mobile.hashListeningEnabled||i.ignoreNextHashChange)i.ignoreNextHashChange=!1;else{if(i.stack.length>1&&b.indexOf(r)>-1)if(a.mobile.activePage.is(".ui-dialog")){var e=function(){b=a.mobile.urlHistory.getActive().page};i.directHashChange({currentUrl:b,
isBack:e,isForward:e})}else{i.directHashChange({currentUrl:b,isBack:function(){window.history.back()},isForward:function(){window.history.forward()}});return}b?a.mobile.changePage(b,{transition:d,changeHash:!1,fromHashChange:!0}):a.mobile.changePage(a.mobile.firstPage,{transition:d,changeHash:!1,fromHashChange:!0})}})})(jQuery);
